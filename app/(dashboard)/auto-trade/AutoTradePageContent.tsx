...
import { BrokerConnect, AutoTradePanel, InfiniteBuyDashboard, OrderHistory, BalancePanel, PositionSync, MarketIndicatorsPanel, TossOrbPanel } from '@/components/auto-trade';
...
import { Bot, Link, History, TrendingUp, Wallet, GitCompare, Zap, TrendingDown, Loader2, LayoutDashboard, Settings, BarChart2, Radio } from 'lucide-react';
    ...
    <div className="container mx-auto max-w-6xl py-6">
      ...
      <Tabs defaultValue="trade" className="space-y-4" onValueChange={(tab) => {
        ...
        <TabsList className="grid w-full grid-cols-9 lg:w-[1170px]">
          ...
          <TabsTrigger value="toss-orb" className="flex items-center gap-2">
