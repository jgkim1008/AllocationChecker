...
const STRATEGIES = [
  ...
  {
    id: 'dual-rsi',
    title: 'MTF RSI + Dual RSI 크로스',
    description: '일봉 RSI(14) 과매도 구간(≤40)에서 단기 RSI(7)이 RSI(14)를 상향 돌파할 때 매수 신호를 포착합니다. 과매도 반전 모멘텀 전략.',
    icon: Zap,
    href: '/strategies/dual-rsi',
  ...
  {
    id: 'rsi-divergence',
    title: 'RSI 다이버전스 + RSI 필터',
    description: '일봉 기준으로 가격이 저점을 낮추는 동안 RSI가 저점을 높이는 불리시 다이버전스를 RSI 과매도(40 이하) 구간에서 포착합니다. 추세 전환의 선행 신호입니다.',
    icon: TrendingUp,
    href: '/strategies/rsi-divergence',
    color: 'bg-orange-50 text-orange-600',
    tag: '신규',
    tagColor: 'bg-orange-100 text-orange-700',
  },
